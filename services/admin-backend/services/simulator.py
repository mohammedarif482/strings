...
class BiometricsSimulator:
    ...
    def generate_historical_seed(self, days: int = 14) -> Dict[str, Any]:
        ...
        for d in range(days, 0, -1):
            ...
            telemetry_records.append(alpha_telem.model_dump() if hasattr(alpha_telem, "model_dump") else alpha_telem.dict())
            ...
            telemetry_records.append(beta_telem.model_dump() if hasattr(beta_telem, "model_dump") else beta_telem.dict())
